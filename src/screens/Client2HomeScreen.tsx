...
type Client2HomeScreenNavigationProp = StackNavigationProp<RootStackParamList, 'Client2Home'>;

interface Props {
  navigation: Client2HomeScreenNavigationProp;
}
...
const Client2HomeScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <BasicHeader
        userName="Emmanual"
        profileImage={require('../assets/Emza.jpg')}
...
export default Client2HomeScreen;